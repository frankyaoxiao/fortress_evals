#!/usr/bin/env python3
"""Bar graph: Persona RL generic vs OLMo sysprompt over training steps."""
...
generic_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_persona_steps/scores_gpt5mini"
olmo_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_persona_olmo_sysprompt/scores"
...
for step in range(50, 525, 50):
    fname = f"7B-Persona-step{step:04d}.jsonl"
...
apply_suptitle(fig, "Persona RL: Effect of OLMo Name in System Prompt Over Training", fontsize=13, y=0.97)

out = os.path.join(os.path.dirname(__file__), "figs/persona_sysprompt_steps.png")

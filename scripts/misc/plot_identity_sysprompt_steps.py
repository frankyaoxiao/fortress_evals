#!/usr/bin/env python3
"""Bar graph: Identity RL generic vs OLMo sysprompt over training steps."""
...
generic_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_identity_generic_sysprompt/scores"
olmo_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_identity_olmo_sysprompt/scores"
...
for step in range(50, 475, 50):
    fname = f"7B-Identity-step{step:04d}.jsonl"
...
apply_suptitle(fig, "Identity RL (trained w/ OLMo sysprompt): Generic vs OLMo at Inference", fontsize=12, y=0.97)

out = os.path.join(os.path.dirname(__file__), "figs/identity_sysprompt_steps.png")

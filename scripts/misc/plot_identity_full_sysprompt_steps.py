#!/usr/bin/env python3
"""Bar graph: Identity Full RL generic vs OLMo sysprompt over training steps."""
...
generic_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_identity_full_generic_sysprompt/scores"
olmo_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_identity_full_olmo_sysprompt/scores"
...
for step in range(50, 325, 50):
    fname = f"7B-IdentityFull-step{step:04d}.jsonl"
...
apply_suptitle(fig, "Identity-Full RL (trained w/ full OLMo sysprompt): OLMo vs Generic at Inference", fontsize=11, y=0.97)

out = os.path.join(os.path.dirname(__file__), "figs/identity_full_sysprompt_steps.png")

#!/usr/bin/env python3
"""Bar graph: MBT-Filter vs R2 eval awareness over training steps."""
...
all_steps = sorted(set(r2_steps) | set(mbt_steps))
...
apply_suptitle(
    fig,
    "Eval Awareness: R2 vs MBT-Filter RL training",
    fontsize=13, y=0.98,
)

out = os.path.join(os.path.dirname(__file__), "figs/mbt_filter_vs_r2.png")

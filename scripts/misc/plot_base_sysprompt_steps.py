#!/usr/bin/env python3
"""Line graph: Base RL generic vs OLMo sysprompt over training steps."""
...
generic_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_base_generic_sysprompt/scores"
olmo_dir = "/home/fxiao/eval_awareness/fortress/runs/hbsr_7b_base_olmo_sysprompt/scores"
...
# Collect data for steps that have BOTH generic and OLMo scores
steps_both = []
generic_rates, generic_los, generic_his = [], [], []
olmo_rates, olmo_los, olmo_his = [], [], []

for step in range(50, 500, 50):
    fname = f"7B-Base-step{step:04d}.jsonl"
...
apply_suptitle(fig, "Base RL: Effect of OLMo Name in System Prompt Over Training", fontsize=13, y=0.97)

out = os.path.join(os.path.dirname(__file__), "figs/base_sysprompt_steps.png")
